...
export default function RescheduleRequestReport() {
  ...
  const reschedules: IRescheduleRequestReportItem[] =
    reschedulesResponse?.data || [];
  ...
  const handlePrint = () => {
    ...
    const printContent = `
        ...
        <body class="bg-white"><div class="mx-auto"><header class="flex justify-between items-start pb-4 border-b-2 border-gray-800"><div><h1 class="text-3xl font-bold text-gray-900">Reschedule Request Report</h1><p class="text-sm text-gray-600">Generated on: ${new Date().toLocaleString(
          "id-ID",
        ...
        <section class="grid grid-cols-3 gap-4 my-6">
            ...
            <div class="bg-green-50 border border-green-200 rounded-lg p-4"><p class="text-sm font-medium text-green-800">Approved / Completed</p><p class="text-2xl font-bold text-green-900">${
              reportSummary.approvedRequests
            }</p></div>
  ...
  const columns: Column<IRescheduleRequestReportItem>[] = [
    ...
    },
    {
      header: "Request Date",
      accessor: (item) =>
        new Date(item.new_end_date).toLocaleDateString("id-ID", {
          day: "2-digit",
          month: "short",
          year: "numeric",
        }),
    ...
    },
    {
      header: "Old Schedule",
      accessor: (item) =>
        new Date(item.booking.start_date).toLocaleDateString("id-ID", {
          day: "2-digit",
          month: "short",
          year: "numeric",
        }),
      cellClassName: "text-red-600 line-through",
    },
    {
      header: "New Schedule",
      accessor: (item) =>
        new Date(item.booking.end_date!).toLocaleDateString("id-ID", {
          day: "2-digit",
          month: "short",
          year: "numeric",
        }),
    ...
    {
      header: "Status",
      accessor: (item) => <RescheduleStatusBadge status={item.status} />,
      ...
      <div className="max-w-7xl mx-auto">
        <header className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900">
            Reschedule Request Report
          </h1>
          <p className="text-md text-gray-600 mt-1">
            Review, filter, and print all reschedule requests.
          </p>
        </header>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
          ...
          <StatCard
            ...
            value={reportSummary.approvedRequests}
            color="green"
          />
          <StatCard
            icon={<Users size={20} />}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 items-end">
            ...
            <div>
              ...
              <select
                ...
                value={status}
                onChange={(e) =>
                  setStatus(e.target.value as RescheduleStatus | "")
                }
        ...
        <footer className="text-center mt-6 text-sm text-gray-500">
          <p>
            ...
            {Array.isArray(reschedules) ? reschedules.length : 0} total
            reschedule requests.
          </p>
        </footer>
      </div>
